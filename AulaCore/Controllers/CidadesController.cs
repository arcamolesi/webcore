...
namespace AulaCore.Controllers
{
    public class CidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nome,uf,qtdeCli")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,uf,qtdeCli")] Cidade cidade)
        {
            if (id != cidade.id)
            {
                return NotFound();
